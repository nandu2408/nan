import AnalyticPageComponent from "./components/AnalyticPageComponent"
...
return(
  <AnalyticPageComponent fetchOrdersForFirstDate={fetchOrdersForFirstDate} fetchOrdersForSecondDate={fetchOrdersForSecondDate} socketIOClient={socketIOClient} />
)
}
