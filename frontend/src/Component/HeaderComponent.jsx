 ...
 const submitHandler = (e) => {
  ...
  if (searchQuery.trim()) {
      if (searchCategoryToggle === "All") {
          ...
          navigate(`/productlistpage/category/${searchCategoryToggle.replaceAll("/", ",")}/search/${searchQuery}`);
      }
  } else if (searchCategoryToggle !== "All") {
      navigate(`/productlistpage/category/${searchCategoryToggle.replaceAll("/", ",")}`);
  } else {
    ...
    <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
      <Container>
        <LinkContainer to="/home">
          <Navbar.Brand href="/home">BEST ONLINE SHOP</Navbar.Brand>
        </LinkContainer>
